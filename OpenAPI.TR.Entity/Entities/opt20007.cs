...
/// <summary>업종주봉조회요청</summary>
public class Opt20007 : TR
{
    /// <summary>업종주봉차트</summary>
    [DataMember, JsonProperty("업종주봉차트")]
    public SingleOpt20007? SingleResponse
    {
        get; set;
    }
    /// <summary>업종주봉조회</summary>
    [DataMember, JsonProperty("업종주봉조회")]
    public MultiOpt20007[]? MultiResponse
    {
        get; set;
    }
    /// <summary>
