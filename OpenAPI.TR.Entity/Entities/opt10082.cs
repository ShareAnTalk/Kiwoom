...
/// <summary>주식주봉차트조회요청</summary>
public class Opt10082 : TR
{
    /// <summary>주식주봉차트</summary>
    [DataMember, JsonProperty("주식주봉차트")]
    public SingleOpt10082? SingleResponse
    {
        get; set;
    }
    /// <summary>주식주봉차트조회</summary>
    [DataMember, JsonProperty("주식주봉차트조회")]
    public MultiOpt10082[]? MultiResponse
    {
        get; set;
    }
    /// <summary>
